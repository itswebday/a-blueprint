...
export interface Media {
  id: number;
  /**
   * Alternative text for the file (for SEO)
   */
  alt: string;
  updatedAt: string;
  createdAt: string;
...
export interface Page {
  ...
  /**
   * Automatisch gegenereerd op basis van de title
   */
  slug?: string | null;
  url: string;
  /**
...
export interface TaskSchedulePublish {
  input: {
    ...
    global?:
      | ('navigation' | 'footer' | 'home' | 'blog' | 'privacy-policy' | 'cookie-policy' | 'terms-and-conditions')
      | null;
